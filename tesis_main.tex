...
\input{marco_teorico/marco_teorico.tex} 
\chapter{Simulaciones}
\input{simulaciones/simulaciones.tex}
\chapter{Resultados y Discusión}
\input{resultados_discusion/resultados_discusion.tex}
\chapter{Conclusiones}
\input{conclusiones/conclusiones.tex}
\begin{appendices}
\chapter{Presión}
\input{apendices/apendice_presion.tex}
\chapter{Script básico de Lammps}
\input{apendices/script_basico}
\chapter{Caracterísicas del cluster}
\input{apendices/caracteristicas_tecnicas.tex}
\end{appendices}
